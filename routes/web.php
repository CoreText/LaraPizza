...
Route::get('/ingredient/{ingredient}/edit', [App\Http\Controllers\IngredientsController::class, 'edit'])->name('profile.edit');
Route::patch('/ingredient/{ingredient}', [App\Http\Controllers\IngredientsController::class, 'update'])->name('profile.update');
