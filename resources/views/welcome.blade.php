...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <div class="container">
                <h1 class="special-title">Lara's Pizza <small>(Build v{{ Illuminate\Foundation\Application::VERSION }})</small></h1>

                <div class="row pt-4 card-list">
                    <article class="col col-sm-4 p-0 mt-4 text-center">
                        <div class="card card-item">
                            <img class="card-img-top" src="https://via.placeholder.com/100x50" alt="">
                            <div class="card-body">
